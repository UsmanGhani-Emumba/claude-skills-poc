...
This document provides examples of how to spawn parallel sub-agents using the instrumented Python agent (`scripts/gemini_agent.py`) with full Arize observability.
...
```
.gemini/logs/tasks/1a.txt  →  "Research AI Diagnostics using web search..."
.gemini/logs/tasks/1b.txt  →  "Fetch FDA AI guidance documents from..."
.gemini/logs/tasks/2a.txt  →  "Search for Drug Discovery AI articles..."
```
...
```
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/1a.txt --tools web_search --agent-id 1a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/1b.txt --tools web_fetch  --agent-id 1b --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/2a.txt --tools web_search --agent-id 2a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/3a.txt --tools web_search --agent-id 3a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/3b.txt --tools github_cli --agent-id 3b --skill researcher
```
...
```json
{
  ...
  "metrics": {
    ...
    "tool_calls_count": 1,
    "api_calls": 1,
    "context_tokens_peak": 2100,
    "context_tokens_total": 2100,
...
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/1b.txt --tools web_fetch  --agent-id 1b --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/2a.txt --tools web_search --agent-id 2a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/2b.txt --tools web_fetch  --agent-id 2b --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/3a.txt --tools web_search --agent-id 3a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/4a.txt --tools web_search --agent-id 4a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/4b.txt --tools web_fetch  --agent-id 4b --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/5a.txt --tools web_search --agent-id 5a --skill researcher
Bash: /c/Python311/python.exe scripts/gemini_agent.py --task-file .gemini/logs/tasks/5b.txt --tools web_fetch  --agent-id 5b --skill researcher
```
...
|-------|------|-------------|---------------|------|---------|
| 1a | web_search | 2,100 | 450 | $0.0004 | 8.2s |
| 1b | web_fetch | 3,200 | 600 | $0.0006 | 12.1s |
| 2a | web_search | 1,800 | 380 | $0.0003 | 7.5s |
| ... | ... | ... | ... | ... | ... |
| **Total** | | **22,400** | **4,200** | **$0.0039** | **9.1s avg** |
...
3. **Metrics logged locally AND to Arize** — `.gemini/logs/arize_metrics.jsonl` always has the data
