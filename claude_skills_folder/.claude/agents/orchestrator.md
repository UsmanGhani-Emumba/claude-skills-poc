...
|-------|---------|----------|
| Researcher | "research", "find info", "investigate" | .claude/skills/researcher/ |
| Writer | "write", "draft", "compose" | .claude/skills/writer/ |
| Reviewer | "review", "edit", "feedback" | .claude/skills/reviewer/ |
| Publisher | "publish", "post to Notion" | .claude/skills/publisher/ |
